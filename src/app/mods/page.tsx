...
import { PolicyRecommendationModel } from '@/components/mods/policy-recommendation-model';
...
const ModelsPage = () => {
  ...
  const tabs = [
    ...
    { id: 'policy-model', label: 'Political Dynamics', icon: Scale },
