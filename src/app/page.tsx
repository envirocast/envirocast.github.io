...
export default function HomePage() {
  ...
  const algorithmPoints = [
    "Quantum Superposition for parallel pollution modeling",
    "Machine Learning integration for pattern recognition", 
    "Real-time environmental data processing",
    "Predictive climate change modeling",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-xl font-semibold text-white hover:from-cyan-400 hover:to-purple-500 transition-all duration-300 flex items-center justify-center group">
                  Explore Models
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </button>
                
                <button 
                  className="px-8 py-4 bg-slate-800/50 backdrop-blur-md border border-slate-600 rounded-xl font-semibold text-white hover:bg-slate-700/50 transition-all duration-300 flex items-center justify-center group"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <div className="flex items-center justify-between">
                  <TeamPreview />
                  <button className="px-6 py-3 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg font-semibold text-white hover:from-purple-400 hover:to-cyan-400 transition-all duration-300 flex items-center">
                    Meet the Team
