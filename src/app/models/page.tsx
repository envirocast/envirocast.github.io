...
import { GlobalEnvironmentViz } from '@/components/models/global-environment-viz';
...
const ModelsPage = () => {
  ...
  const tabs = [
    ...
    { id: 'global-environment', label: 'Global Environment', icon: Globe },
  ...
  const QuantumProcessing = () => {
    ...
    return (
      <div className="space-y-8">
        ...
        {/* Additional quantum processing components would go here */}
        {/* (Similar structure to the original but abbreviated for space) */}
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-8">
            ...
            <br />
            <span className="text-white">Environmental Models</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center gap-2 bg-slate-800 rounded-2xl p-2 border border-slate-700">
            {tabs.map((tab) => {
              ...
              const isGlobalEnv = tab.id === 'global-environment';
              return (
                <button
                  key={tab.id}
                  ...
                  className={`flex items-center space-x-2 px-6 py-3 rounded-xl font-medium transition-all ${
                    activeTab === tab.id
                      ...
                      : isGlobalEnv
                      ? 'text-green-400 font-semibold hover:text-green-300 hover:bg-slate-700'
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-cyan-300 to-purple-300 bg-clip-text text-transparent">
              Advanced Environmental Modeling vs Traditional Methods
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              See how our quantum-enhanced environmental modeling system outperforms traditional 
              climate and pollution forecasting approaches.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-400">Limited ground-based monitoring</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">System Integration</span>
            ...
            <motion.div
              className="bg-gradient-to-br from-cyan-900/30 to-green-900/30 rounded-2xl p-8 border border-cyan-500/30"
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
            >
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-green-500 rounded-xl flex items-center justify-center">
                  <Globe className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white">EnviroCast System</h3>
                  <p className="text-cyan-300">Quantum-enhanced global modeling</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Spatial Coverage</span>
                  <span className="text-cyan-400 font-semibold">Global + Multi-layer</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Update Frequency</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Processing Speed</span>
                  <span className="text-cyan-400 font-semibold">Seconds</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Resolution</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">System Integration</span>
                  <span className="text-green-400 font-semibold">Full Ecosystem</span>
                </div>
              </div>
            </motion.div>
          </div>
